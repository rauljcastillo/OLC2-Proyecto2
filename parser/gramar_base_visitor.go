...
func (v *BaseGramarVisitor) VisitProductions(ctx *ProductionsContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseGramarVisitor) VisitPbrk(ctx *PbrkContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseGramarVisitor) VisitPdeclara(ctx *PdeclaraContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseGramarVisitor) VisitParent(ctx *ParentContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseGramarVisitor) VisitAritmetic(ctx *AritmeticContext) interface{} {
	return v.VisitChildren(ctx)
}
